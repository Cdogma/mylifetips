...
const SectionHeading = ({
  ...
  return (
    <div className={`max-w-3xl ${align === "center" ? "mx-auto" : ""} mb-12 ${textAlignment[align]}`}>
      ...
      <h2 className={`${align === "left" ? "title-with-bar" : ""} text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent pb-2`}>{title}</h2>
